...
export const badMoonRisingRoles: readonly SmartRoleDefinition[] = [
  ...
  role({"id":"gossip","name":"造谣者","officialName":"Gossip","team":"townsfolk","abilityText":"Each day, you may make a public statement. Tonight, if it was true, a player dies.","inputKinds":["text"],"possibleOutcomes":["公开陈述为真：今晚可能有一名玩家死亡。","公开陈述为假：无额外死亡。"],"stateChanges":["可能造成说书人选择的一名玩家死亡。"],"highRiskNotes":["先记录公开陈述原文；真假和死亡目标都由说书人确认。"]}),
  ...
  role({"id":"fool","name":"弄臣","officialName":"Fool","team":"townsfolk","abilityText":"The 1st time you die, you don't.","inputKinds":["none"],"possibleOutcomes":["首次死亡被阻止。","首次之后正常死亡。"],"stateChanges":["仅当弄臣将要真正死亡时才消耗免死；被其他能力保护挡下不消耗。"],"highRiskNotes":["需要记录是否已经用过免死。","如果弄臣将要死亡时醉酒或中毒，他会照常死亡，且不放置“失去能力”标记。"]}),
  ...
  role({"id":"tinker","name":"修补匠","officialName":"Tinker","team":"outsider","abilityText":"You might die at any time.","inputKinds":["none"],"possibleOutcomes":["任意时间可能死亡。"],"stateChanges":["可能造成修补匠死亡。"],"highRiskNotes":["死亡时机由说书人裁量，不能自动触发。","修补匠在受到免于死亡的能力保护（如茶艺师、旅店老板）时，不能因自己的能力而死亡。"]}),
  ...
  role({"id":"po","name":"珀","officialName":"Po","team":"demon","abilityText":"Each night*, you may choose a player: they die. If your last choice was no-one, choose 3 players tonight.","inputKinds":["text"],"possibleOutcomes":["选择一名玩家死亡。","若上一晚空刀，本晚必须选择三名玩家（不能再次空刀，也不能少选）。"],"stateChanges":["可能造成 1 名或 3 名玩家死亡。"],"highRiskNotes":["需要记录上一晚是否选择无人；多目标死亡必须人工确认。","如果珀在上一个夜晚不选择任何人时处于醉酒或中毒，当晚珀仍然能够选择三名玩家。"]}),
  ...
  role({"id":"voudon","name":"巫毒师","officialName":"Voudon","team":"traveler","abilityText":"Only you & the dead can vote. They don't need a vote token to do so. A 50% majority isn't required.","inputKinds":["text"]}),
]
